			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="sidebarCollapse">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/pages/admin_user.jsp"> <i
								class="bi bi-people"></i> Users
						</a></li>
						<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/pages/admin_product.jsp">
		...
		function confirmLogout() {
			  Swal.fire({
				    ...
				    if (result.isConfirmed) {
				      Swal.fire(
				        'Successfull!',
				        'You has been successfully log out.',
				        'success'
				      )
				    }
				  })
