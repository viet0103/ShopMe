...
<link
	...
	rel="stylesheet">
<link
	href="<%=request.getContextPath()%>/assets/css/page.css"
	rel="stylesheet">
		...
		<div class="container">
			<div class="row">
				...
				<jsp:include page="../components/cardProduct.jsp">
					<jsp:param value="${pageContext.request.contextPath}/assets/images/product-1.png" name="src" />
				...
				<!-- Start Column 3 -->
				<jsp:include page="../components/cardProduct.jsp">
					<jsp:param value="${pageContext.request.contextPath}/assets/images/product-2.png" name="src" />
				...
				<!-- Start Column 4 -->
				<jsp:include page="../components/cardProduct.jsp">
					<jsp:param value="${pageContext.request.contextPath}/assets/images/product-3.png" name="src" />
				...
				<div class="col-lg-6">
					...
					<div class="row my-5">
						...
						<div class="col-6 col-md-6">
							<div class="feature">
								<div class="icon">
									<img src="<%=request.getContextPath()%>/assets/images/bag.svg" alt="Image"
										class="imf-fluid">
								</div>
								<h3>Easy to Shop</h3>
								<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac
